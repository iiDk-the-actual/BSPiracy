namespace BSPiracy
{
    public class Logger
    {
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Info, log.ToString());
        }
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Info, string.Format(log.ToString(), args));
        }
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Error, log.ToString());
        }
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Error, string.Format(log.ToString(), args));
        }
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Warning, log.ToString());
        }
        ...
        {
            Plugin.PluginLogger.Log(IPA.Logging.Logger.Level.Warning, string.Format(log.ToString(), args));
        }
    }
}